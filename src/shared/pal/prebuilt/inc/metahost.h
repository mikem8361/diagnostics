...
#define ICLRDebuggingLibraryProvider3_ProvideUnixLibrary(This,pwszFileName,pbBuildId,iBuildIdSize,ppResolvedModulePath)	\
    ( (This)->lpVtbl -> ProvideUnixLibrary(This,pwszFileName,pbBuildId,iBuildIdSize,ppResolvedModulePath) ) 
