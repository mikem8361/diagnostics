...
namespace Microsoft.Diagnostics.DebugServices.Implementation
{
    ...
    public class ThreadServiceFromDataReader : ThreadService
    {
        ...
        internal protected override bool GetThreadContext(uint threadId, uint contextFlags, byte[] context)
        {
            try
            {
        ...
        internal protected override ulong GetThreadTeb(uint threadId)
        {
