...
namespace Microsoft.Diagnostics.SOSConcord
{
    ...
    /// </summary>
    internal class ThreadServiceFromConcordServices : ThreadService
    {
        internal class ThreadFromConcordServices : Thread
        {
        ...
        internal ThreadServiceFromConcordServices(TargetFromConcordServices target)
            : base(target)
        {
        }
