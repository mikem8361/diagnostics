...
{
    public sealed class ManagedCallbackWrapper : COMCallableIUnknown, IDisposable
    {
        ...
        public ManagedCallbackWrapper()
        {
            ...
            builder.AddMethod(new CreateProcessDelegate((self, pProcess) => WriteLine("CreateProcess")));
        ...
        {
            Trace.TraceInformation("ManagedCallbackWrapper.Destroy");
        }
