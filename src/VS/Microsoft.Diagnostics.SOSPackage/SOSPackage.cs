...
namespace Microsoft.Diagnostics.SOSPackage
{
    ...
    public sealed class SOSPackage : AsyncPackage, IOleCommandTarget, VisualStudio.OLE.Interop.IServiceProvider, IVsCustomDebuggerEventHandler110
    {
        ...
        /// </summary>
        private static readonly Guid guidSOSPackageCmdSet = new Guid("c0ecea67-cdd1-42ec-93e3-98de4d357fb5");
        ...
        protected override async Task InitializeAsync(CancellationToken cancellationToken, IProgress<ServiceProgressData> progress)
        {
            ...
            SVsShellDebugger debugger = (SVsShellDebugger)await GetServiceAsync(typeof(SVsShellDebugger));
        ...
        int IOleCommandTarget.Exec(ref Guid cmdGroup, uint nCmdID, uint nCmdExecOpt, IntPtr pvaIn, IntPtr pvaOut)
        {
            ...
            if (cmdGroup == SOSPackage.guidSOSPackageCmdSet)
            {
                switch (nCmdID)
                {
                    case sosCommandId:
        ...
        /// </summary>
        private static bool IsQueryParameterList(System.IntPtr pvaIn, System.IntPtr pvaOut, uint nCmdexecopt)
        {
        ...
        private int SendMessage(DkmProcess process, SOSConcordServiceMessageId messageId, object parameter1, object parameter2)
        {
            try
            {
